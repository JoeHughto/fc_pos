<?php
// count.php
// takes data as post and enters counts and deposits
// deposits must have counts associated with them
// if user has mem authority, will show last 50 counts
   ...
   if(($_POST['count'] > 0 || $_POST['deposit'] > 0) && $_POST['confirmed'] == "Confirm")
   {
      ...
      if($count > 0)
      {
         ...
         echo "</table>\n";
         if($difference > 5) echo "Notice: Count is off by over \$5. That's bad.<hr>";
         ...
         mail("michael@pvgaming.org, mc@pvgaming.org", "FC Deposit Count", $emessage); 
   ...
   elseif ($_POST['count'] > 0 || $_POST['deposit'] > 0)
   {
      ...
      if($count > 0)
      {
         ...
         echo "<h2>Count Results</h2>
               ...
               <tr><td><b>Cash missing: </b></td><td><b>" . money($difference) . "</b> (positive is bad, negative is extra money)</td></tr>";
         echo "</table>\n";
         if($difference > 5) echo "Notice: Count is off by over \$5. Please double check the count, and only confirm if you're sure this count is correct.<br>";
