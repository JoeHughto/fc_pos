<?php
// fgreport.php
// Report of members by sales to determine placement
...
Second place gets $10 and Third gets $5. Furthermore, each of these three will get a medal in the 
<a href='http://www.worldsapartgames.org/hallofheroes.php' target='hero'>Hall of Heroes</a>.
...
{  
   if($salesa[$key] > 0)
      echo "<tr><td>" . ($key + 1) . "</td><td>$name({$memnum[$key]})</td>
                <td>" . money($salesa[$key]) . "</td><td>" . FG_discountNow($memnum[$key]) . "</td></tr>\n";
}
echo "</table><p>";
?>