...
<?php
   ...
   $lastmonth1 = date_format($date, "Y-m-1");
    ...
    if($_SESSION['reg'] == 1) echo "<a href='register.php'>Sales Register</a><br>";
    if($_SESSION['reg'] == 1) echo "<a href='viewreceipts.php?start=$yesterday&end=$now'>View Receipts</a><br>";
    $cxn = open_stream();
    ...
    if($_SESSION['reg'] == 1) echo "<br><a href='schedule.php?start=$now&end=$twoWeeks'>Schedule</a><br>";
    if($_SESSION['reg'] == 1) echo "<a href='viewspecialorders.php'>Special Order Report</a><br>";
    if($_SESSION['reg'] == 1) echo "<br>";
    if($_SESSION['reg'] == 1) echo "<a href='count.php'>Cash Count</a>";
    echo "<hr>";
    ...
    if($_SESSION['inv'] == 1) echo "<a href='buycards.php'>Buy Cards</a><br>";
    ...
    if($_SESSION['reg'] == 1 || $_SESSION['mem'] == 1)
    {
        ...
        if($_SESSION['mem'] == 1) echo "<a href='viewhowfound.php'>How Found Report</a>";
        echo "<hr>";
    }
    
    echo "<b>Events</b><br>";
    if($_SESSION['eve'] == 1) echo "<a href='setevents.php'>Set Up Events</a><br>";
    if($_SESSION['eve'] == 1) echo "<a href='prizepool.php'>Prize Pool Events</a><br>";
